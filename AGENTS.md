...
* **Template Project**: The maintained reusable template itself. Root `README.md`, root `AGENTS.md`, `.specs/template/`, template-maintenance specs, and template-focused Codex skills describe how to maintain and copy this template.
* **Generated Project**: The project scaffold after the template is copied and renamed. `.specs/generated/` contains root-file replacements and starter specs that should become the new repo's own `README.md`, `AGENTS.md`, and `specs/`.

When maintaining this repo, keep both layers aligned. When creating a new repo from this template, use `.codex/skills/create-project-from-template/SKILL.md`; do not manually mix Template Project docs into the generated project's root docs.
...
* Keep the root `README.md` Dioxus Features section updated as development continues whenever Dioxus feature usage, Dioxus Components usage, routes, cache behavior, platform support, or suggested future work changes.
